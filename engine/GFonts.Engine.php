...
class GFontsEngine {
    ...
    static public function RegisterSettings() {
        //register_setting(GFontsEngine::PLUGIN_SLUG, GFontsEngine::PLUGIN_OPTION_VERSION);
        //register_setting(GFontsEngine::PLUGIN_SLUG, GFontsEngine::PLUGIN_OPTION_FONTLIST);
        //register_setting(GFontsEngine::PLUGIN_SLUG, GFontsEngine::PLUGIN_OPTION_FONT_UPDATE_STATE);
        //register_setting(GFontsEngine::PLUGIN_SLUG, GFontsEngine::PLUGIN_OPTION_FONT_UPDATE_STATE_MESSAGE);
        //register_setting(GFontsEngine::PLUGIN_SLUG, GFontsEngine::PLUGIN_OPTION_FONT_UPDATE_DATE);
        //register_setting(GFontsEngine::PLUGIN_SLUG, GFontsEngine::PLUGIN_OPTION_FONT_DATABASE);
    ...
    static public function AddMenuItem() {
        $mp = add_menu_page(GFontsEngine::PLUGIN_MENU_TITLE, GFontsEngine::PLUGIN_MENU_NAME, 'level_10', GFontsEngine::PLUGIN_SLUG, array('GFontsEngine', 'MainOptions'));
        add_submenu_page(GFontsEngine::PLUGIN_SLUG, __('Install / Uninstall', GFontsEngine::PLUGIN_SLUG), __('Install / Uninstall', GFontsEngine::PLUGIN_SLUG), 'level_10', GFontsEngine::PLUGIN_SLUG, array('GFontsEngine', 'MainOptions'));
...
//add_options_page(GFontsEngine::PLUGIN_MENU_NAME, GFontsEngine::PLUGIN_MENU_NAME, 'level_10', GFontsEngine::PLUGIN_SLUG, array('GFontsEngine', 'MainOptions'));
    ...
    static public function MainOptions() {
        ...
        <div style="margin-top: 20px;">
            <button class="button button-primary" onclick="return ShowPreview();"><?php _e('Show example', GFontsEngine::PLUGIN_SLUG); ?></button>&nbsp;&nbsp;
            <button class="button button-primary" onclick="return ShowPreviewForAll(1);"><?php _e('Show all fonts', GFontsEngine::PLUGIN_SLUG); ?></button>&nbsp;&nbsp;
            ...
            <br/><br/>
            <input type="checkbox" name="gf_autopreview" id="gf_autopreview" checked="true"/><label for="gf_autopreview"><?php _e('Auto preview', GFontsEngine::PLUGIN_SLUG) ?></label>
            <br/><br/>
        ...
        print '<script type="text/javascript" src="' . PLUGIN_URL . 'js/backend.js"></script>';
    }
        ...
        if (!$serializedItems) {
            ...
            foreach ($items as $item) {
                if ($item['name'] == $_POST['font']) {
                    // output of css
                    $cssUrl = 'http://fonts.googleapis.com/css?family=' . str_replace(' ', '+', $item['name']);
                    $cssUrl .= ':';
...
/* ]]> */
    ...
    static public function FontList() {
        ...
        printf("<li class='all'><a href='admin.php?%s' class=\"current\">%s <span class=\"count\">(%d)</span></a> |</li>", 'page=' . GFontsEngine::PLUGIN_FONT_LIST, __('All', GFontsEngine::PLUGIN_SLUG), isset($stats[2]) ? $stats[2]->qty : 0);
        printf("<li class='used'><a href='admin.php?%s&f=used'>%s <span class=\"count\">(%d)</span></a> |</li>", 'page=' . GFontsEngine::PLUGIN_FONT_LIST, __('Used', GFontsEngine::PLUGIN_SLUG), isset($stats[0]) ? $stats[0]->qty : 0);
        printf("<li class='used'><a href='admin.php?%s&f=unused'>%s <span class=\"count\">(%d)</span></a></li>", 'page=' . GFontsEngine::PLUGIN_FONT_LIST, __('Unused', GFontsEngine::PLUGIN_SLUG), isset($stats[1]) ? $stats[1]->qty : 0);
        print "</ul>";
    ...
    static public function AddFiltersToPostList() {
        ...
        print '</select>';
        printf("<input type=\"checkbox\" id=\"nofont\" name=\"nofont\" value=\"1\"%s />&nbsp;<label for=\"nofont\">No fonts posts</label>&nbsp;", (isset($_GET['nofont']) && $_GET['nofont'] == 1) ? " checked" : "");
    ...
    static public function FontSize() {
        ...
        <table class="form-table">
            <tr valign="top">
                <th scope="row"><?php print __("Enabled Extra Font Sizes", GFontsEngine::PLUGIN_SLUG); ?></th>
                <td><input type="checkbox" name="<?php echo GFontsEngine::PLUGIN_OPTION_FONT_SIZE_ENABLED ?>" <?php echo (get_option(GFontsEngine::PLUGIN_OPTION_FONT_SIZE_ENABLED, true)) ? "checked" : ""; ?> /></td>
            </tr>

            <tr valign="top">
                <th scope="row"><?php print __("Min size (6px min)", GFontsEngine::PLUGIN_SLUG); ?></th>
                <td><input type="text" name="<?php echo GFontsEngine::PLUGIN_OPTION_FONT_SIZE_MINIMUM ?>" value="<?php echo get_option(GFontsEngine::PLUGIN_OPTION_FONT_SIZE_MINIMUM, 6); ?>" /></td>
            </tr>

            <tr valign="top">
                <th scope="row"><?php print __("Max size (48px max)", GFontsEngine::PLUGIN_SLUG); ?></th>
                <td><input type="text" name="<?php echo GFontsEngine::PLUGIN_OPTION_FONT_SIZE_MAXIMUM ?>" value="<?php echo get_option(GFontsEngine::PLUGIN_OPTION_FONT_SIZE_MAXIMUM, 48); ?>" /></td>
            </tr>
